...
Revision ID: 997eecb7d96b
Revises:
Create Date: 2025-08-16 21:23:17.844360
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("USER", "ADMIN", name="client_roles"), nullable=False
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "op_status",
            sa.Enum("PENDING", "SUCCESS", "FAILED", name="operation_status"),
